const app = Vue.createApp({
    ...
    methods: {
	    ...
	    var table = new Tabulator("#controls-table", {
 	    ...
 	    layout:"fitColumns",
 	    columns:[ //Define Table Columns
	 	{title:"Manufacturer", field:"a", width:80},
	 	{title:"Product Code", field:"b", width:80},
	 	{title:"Description", field:"c", width:80},
	 	{title:"Features", field:"d", formatter:"textarea", width:200},
	 	{title:"Engineering", field:"e", width:50},
	 	{title:"Performance", field:"f", width:50},
	 	{title:"Reliability", field:"g", width:50},
	 	{title:"Cost", field:"h", width:100},
	 	{title:"Real World", field:"i", formatter:"textarea", width:200},
 	        ],
            });    
	    },
