const app = Vue.createApp({
    ...
    methods: {
	    ...
	    var table = new Tabulator("#controls-table", {
 	    ...
 	    layout:"fitColumns",
 	    columns:[ //Define Table Columns
	 	{title:"Manufacturer", field:"a", width:120},
	 	{title:"Product Code", field:"b", width:120},
	 	{title:"Description", field:"c", width:150},
	 	{title:"Features", field:"d", formatter:"textarea", width:250},
	 	{title:"Engineering", field:"e", width:100},
	 	{title:"Performance", field:"f", width:100},
	 	{title:"Reliability", field:"g", width:100},
	 	{title:"Cost", field:"h", width:100},
	 	{title:"Real World", field:"i", formatter:"textarea", width:250},
 	        ],
            });    
	    },
