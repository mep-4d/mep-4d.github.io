const app = Vue.createApp({
    ...
    methods: {
	    ...
	    var table = new Tabulator("#controls-table", {
	 	...
	 	{title:"Product", field:"b", width:100},
	 	{title:"Description", field:"c", width:120},
	 	{title:"Features", field:"d", formatter:"textarea", width:220},
	 	{title:"Engineering", field:"e", width:80},
	 	{title:"Performance", field:"f", width:80},
	 	{title:"Reliability", field:"g", width:80},
	 	{title:"Cost", field:"h", width:80},
